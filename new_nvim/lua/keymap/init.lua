...
keymap("n", "<C-\\>", [[execute v:count . "ToggleTerm direction=horizontal"]], opts)
--keymap("n", "<C-\\>", "<Esc><Cmd>ToggleTerm direction=horizontal<CR>", opts)
...
keymap("n", "<F4>", [[execute v:count . "ToggleTerm direction=vertical"]], opts)
keymap("i", "<F4>", "<Esc><Cmd>ToggleTerm direction=vertical<CR>", opts)
keymap("t", "<F4>", "<Esc><Cmd>ToggleTerm<CR>", opts)
keymap("n", "<A-d>", [[execute v:count . "ToggleTerm direction=float"]], opts)
